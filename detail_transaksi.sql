...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2023 at 10:43 AM
...
--
ALTER TABLE `detail_transaksi`
  ADD CONSTRAINT `detail_transaksi_ibfk_1` FOREIGN KEY (`id_produk`) REFERENCES `produkk` (`id_produk`) ON DELETE CASCADE ON UPDATE CASCADE,
